      ...
      <div className="py-4">
        ...
        <MobileSection id="introducao">
          ...
          <MobileText>
            ...
            Sigmar, dedicados à erradicação de toda magia e heresia do Império.
            Liderados por Inquisidores implacáveis, estes bandos são formados
            por sacerdotes marciais, caçadores especializados e fanáticos
            dispostos a morrer pela causa sagrada.
          </MobileText>
          <MobileText>
        ...
        <MobileSection id="estrutura-do-bando">
          ...
          <MobileText>
            ...
            modelos. Você tem 500 coroas de ouro que pode usar para recrutar e
            equipar seu bando. O número máximo de guerreiros no bando é 12.
          </MobileText>
          <MobileText>
            • <strong>Inquisidor:</strong> Cada bando dos Caçadores de Bruxas
            deve ter um Inquisidor – nem mais, nem menos!
            <br />• <strong>Sacerdote Marcial de Sigmar:</strong> Seu bando pode
            incluir até 1 Sacerdote Marcial de Sigmar.

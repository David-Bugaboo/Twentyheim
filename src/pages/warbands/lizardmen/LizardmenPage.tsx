      ...
      <div className="py-4">
        ...
        <MobileSection id="introducao">
          ...
          <MobileText>
            ...
            selvas tropicais de Lustria, onde construíram vastas cidades-templos
            de pedra e ouro.
          </MobileText>
          <MobileText>
            Os Reptilianos são divididos em várias castas: os Saurídeos são os
            guerreiros, os Geckos são os servos e artesãos, e os Slann são seus
            seus líderes supremos. Cada casta tem sua função específica na
            sociedade reptiliana, e todos servem aos Grandes Planos dos Antigos.
          </MobileText>
          <MobileText>
            Em Mordheim, os Reptilianos são uma presença rara mas temível. Eles
            vêm em busca de artefatos dos Antigos ou para cumprir profecias
            antigas. Sua tecnologia avançada e poderes místicos os tornam
        ...
        <MobileSection id="estrutura-do-bando">
          ...
          <MobileText>
            ...
            500 coroas de ouro que pode usar para recrutar e equipar seu bando.
          ...
          <MobileText>
            ...
            <br />• <strong>Guerreiro Totêmico Saurídeo:</strong> Seu bando pode
            incluir até 1 Guerreiro Totêmico Saurídeo.
        ...
        <MobileSection id="marcas-sagradas">
          ...
          <MobileText>
            As Marcas Sagradas são bênçãos dos deuses reptilianos que podem ser
            concedidas aos guerreiros mais dignos. Cada marca tem restrições
            específicas e custos diferentes.
          </MobileText>
          <MobileText>
            <strong>Regras das Marcas Sagradas:</strong>
            <br />• Apenas <strong>heróis</strong> podem receber Marcas Sagradas
          ...
          <div className="space-y-6">
            {sacredMarksData.map((mark: SacredMark, index) => (
              ...
              >
                <HeaderH2 className="text-green-300 mb-2">{mark.name}</HeaderH2>
                <div className="mb-3">

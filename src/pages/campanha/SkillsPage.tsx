      ...
      <div className="py-4">
        <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48">
          <MobileSection>
            ...
            <HeaderH2>Gatilho</HeaderH2>O gatilho que permite o uso da
            habilidade. Lembre-se que no caso de multiplas habilidades com o
            mesmo gatilho usadas ao mesmo tempo, o jogador que está ativando
            atualmente escolhe a ordem de resolução das habilidades.
            ...
            alvos que atinge e etcetera. Pode ser uma descrição detalhada do

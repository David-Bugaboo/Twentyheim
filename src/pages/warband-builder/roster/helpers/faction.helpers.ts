...
export function getFactionLabel(factionKey: string): string {
  const map: Record<string, string> = {
    ...
    "vampire-courts-von-carstein": "Cortes Vampíricas",
    "vampire-courts-blood-dragon": "Cortes Vampíricas",
    "vampire-courts-necrarch": "Cortes Vampíricas",
    "vampire-courts-lahmia": "Cortes Vampíricas",
    "vampire-courts-strigoi": "Cortes Vampíricas",
    ...
    "mercenaries-reikland": "Mercenários",
    "mercenaries-middenheim": "Mercenários",
    "mercenaries-marienburg": "Mercenários",
    "mercenaries-ostermark": "Mercenários",

...
//               viajaram por todo o Império cuidando dos doentes e pobres,
//               atendendo às necessidades dos órfãos, curando os enfermos e
//               tratando dos corpos feridos. Além das artes de cura, que praticam
//               com profundo conhecimento de ervas e orações, seu conselho é
//               frequentemente procurado por aqueles prestes a tomar decisões
//               importantes, pois as Irmãs de Sigmar são famosas por sua
//               habilidade em prever o volúvel curso do destino.
//             </MobileText>
//             <MobileText>
//               Embora outrora muito amadas pelo povo, as Irmãs têm visto sua
//               popularidade diminuir nos últimos anos. Caçadores de bruxas
//               fanáticos as denunciaram como feiticeiras e hereges, e até mesmo
//               nos campos elas têm sido atacadas e expulsas pelos próprios
//               camponeses que procuram ajudar. Muitos sacerdotes de Sigmar
//               desejam dissolver a ordem completamente, alegando que mulheres não
//               têm o direito de ensinar a palavra sagrada de Sigmar.
//             </MobileText>
//             <MobileText>
...
//               previsto o desastre, e durante suas vigílias noturnas as Donzelas
//               de Sigmar ouviram a voz do próprio deus sussurrando em suas mentes
...
//               próprio Sigmar, ao qual devem se dedicar de corpo e alma. Seu
//               dever divino é reunir os fragmentos de Pedra-Bruxa e escondê-los
//               profundamente sob a Rocha de Sigmar, nos cofres do convento, onde,
//               protegidos por camadas de granito sólido e pelas preces eternas da
//               irmandade, não possam causar mal ao povo de Sigmar.
//             </MobileText>
//           </MobileSection>
...
//               bando. O número máximo de guerreiros no bando é 15.
//             </MobileText>
//             <MobileText>
//               • <strong>Matriarca Sigmarita:</strong> Cada bando deve ter uma
//               Matriarca – nem mais, nem menos!
//               <br />• <strong>Irmã Superior:</strong> Seu bando pode incluir até
//               3 Irmãs Superiores.
//               <br />• <strong>Áugure:</strong> Seu bando pode incluir até 1
//               Áugure.
//               <br />• <strong>Irmã Sigmarita:</strong> Seu bando pode incluir de
//               1 a 5 Irmãs Sigmaritas.

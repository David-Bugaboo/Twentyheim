  ...
  const regions: Region[] = [
    {
      ...
      specialRules: [
        "Disciplina e Lealdade: Reiklanders são conhecidos por sua disciplina e lealdade como guerreiros profissionais.",
        "Orgulho do Grão-Príncipe: São justamente orgulhosos de seu dinâmico e ambicioso Grão-Príncipe.",
        "Desprezo por Middenheim: São desdenhosos de outros pretendentes ao trono, especialmente o Conde de Middenheim, Mannfred Todbringer, a quem chamam desdenhosamente de 'cão de colo de Ulric'.",
      ],
    },
    {
      id: "middenheim",
    ...
    },
    {
      ...
      specialRules: [
        "Patrocinador: Para refletir o patrocinio que recebem de grandes mercados, os bandos de Mariemburg começam com 100 coroas adicionais para montar seu bando.",
      ...
      <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48">
        ...
        <MobileSection id="introducao">
          ...
          <MobileText variant="quote">
            Esta é uma época de guerra incessante, conflito civil, violência e
            fome. Uma época de crianças órfãs e matança desenfreada. Para os
            guerreiros, estes são bons tempos! Desde a descoberta da pedra
            wyrdstone, Mordheim se tornou um ímã para homens de combate de todo
            o Império.
          </MobileText>
          <MobileText>
            Nobres, mercadores e o próprio Templo de Sigmar oferecem ricas
            recompensas por fragmentos da misteriosa pedra. Entre os principais
            patronos dos guerreiros mercenários estão os o Grão-Príncipe de
            Reikland, o Conde de Middenheim,Lady Magritta de Marienburg –
            favorita das guildas mercantis e as Ligas Coletivistas de Ostenmark.
          </MobileText>
        </MobileSection>
        ...
        <MobileSection id="estrutura-do-bando">
          ...
          <MobileText>
            ...
            Espadachins.
            <br />• <strong>Cão de Guerra:</strong> Seu bando pode incluir até 5
            Cães de Guerra.
          </MobileText>
        </MobileSection>

...
function ExplorationEventsPage() {
  const explorationEvents = [
    ...
    {
      Evento: "Carroça Virada",
      "Tipo de rolagem": "Duplos",
      números: "13-16",
    },
    {
      Evento: "Loja Arruínada",
      "Tipo de rolagem": "Duplos",
      números: "17-19",
    },
    {
    ...
    {
      Evento: "Salão de Comércio",
      "Tipo de rolagem": "Duplos",
      números: "17-19",
    },
    {
      Evento: "Pagando uma Dívida",
      "Tipo de rolagem": "Triplos",
      números: "20",
    },
    {
    ...
    {
      Evento: "Oficina de Engeneheiro Militar",
    ...
    {
      Evento: "Mansão do Banqueiro",
      "Tipo de rolagem": "Quintuplos",
      números: "1-4",
    },
    {
      Evento: "Laboratório de Alquímia",
      "Tipo de rolagem": "Quintuplos",
      números: "5-8",
    },
    {
    ...
    {
      Evento: "Mansão do Mercador",
      "Tipo de rolagem": "Quintuplos",
      números: "13-16",
    },
    {
      Evento: "Prédio Rachado",
      "Tipo de rolagem": "Quintuplos",
      números: "17-19",
    },
    {
      Evento: "Entrada das Catacumbas",
      "Tipo de rolagem": "Quintuplos",
      números: "20",
    },
    {
    ...
    {
      Evento: "Bando Massacrado",
      "Tipo de rolagem": "Sextuplos",
      números: "13-16",
    },
    {
      Evento: "As Arenas Clandestinas",
      "Tipo de rolagem": "Sextuplos",
      números: "17-19",
    },
    {
      Evento: "O Condomínio a Beira do Lago",
      "Tipo de rolagem": "Sextuplos",
      números: "20",
    },
  ];
      ...
      <div className="py-4">
        <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48">
          <MobileSection>
            ...
            <GenericTable data={explorationEvents} scrollable={false} />

            <HeaderH1>Descrições dos Eventos</HeaderH1>

            <HeaderH2>Duplos (1-4,1-4) - O Poço</HeaderH2>
            <MobileText>
              Os poços públicos de Mordheim, dos quais havia vários, eram
              cobertos por telhados erguidos sobre pilares e adornados com
              esculturas e fontes. A cidade se orgulhava de seu sistema de água.
              Infelizmente, como todos os outros poços, este está em estado
              precário e sem dúvida poluído com Pedra-Bruxa.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              A loja da Guilda dos Mercadores foi completamente saqueada. Mesmo
              assim, ainda há itens espalhados pela sala única e comprida,
              misturados com os escombros. Alguns são úteis, como panelas e
              frigideiras de ferro fundido e rolos de tecido fino. Todo tipo de
              itens menores estão espalhados - o tipo de bugiganga que não tem
              mais utilidade em uma cidade devastada com poucos habitantes.
            </MobileText>
            <MobileText>
              Após uma busca minuciosa você encontra saque no valor de D20/5
              (arredonde para baixo) coroas de ouro. Se rolar 18, 19 ou 20, você
              também encontrará um Amuleto da Sorte.
            </MobileText>

            <HeaderH2>Duplos (9-12,9-12) - Cadáver</HeaderH2>
            <MobileText>
              Você encontra um cadáver fresco. Uma adaga lascada está cravada em
              suas costas. Surpreendentemente, suas posses não foram roubadas.
            </MobileText>
            <MobileText>
              Para ver o que você encontra ao revistar o cadáver, role um D20:
            </MobileText>
            <MobileText>
              <strong>1-7:</strong> 1D20/5 (arredonde para baixo) coroas de ouro
              <br />
            ...
            <MobileText>
              ...
              escravidão) e ganhar 1d20/2 (arredonde para baixo) coroas de ouro.
            </MobileText>
            <MobileText>
              <strong>
              ...
              podem sacrificar o infeliz pela glória de seus deuses profanos. O
              líder do bando ganhará +50 de Experiência.
            </MobileText>
            <MobileText>
              <strong>Bandos Mortos-Vivos</strong> podem matar o homem e ganhar
              um Zumbi sem custo.
            </MobileText>
            <MobileText>
              <strong>Qualquer outro bando</strong> pode interrogar o homem e
              ganhar insight sobre a cidade. Na próxima vez que rolar na tabela
              de Exploração, role um dado a mais do que normalmente permitido, e
              descarte qualquer um dos dados.
            </MobileText>
            ...
            <MobileText>
              ...
              veraneio. Como qualquer pessoa importante fugiu há muito tempo, o
              que ela está fazendo aqui? Os cavalos se soltaram, ou alguém os
              libertou?
            </MobileText>
            ...
            <MobileText>
              ...
              <br />
              <strong>8-15:</strong> Uma bolsa com 1d20/2 (arredonde para baixo)
              coroas de ouro
              <br />
              <strong>16-20:</strong> Espada e adaga cravejadas de joias. Estes
              podem ser mantidos ou vendidos pelo dobro do valor de uma espada e
              adaga normais.
            </MobileText>
            ...
            <MobileText>
              Você encontra saque no valor de 1d20/5 (arredonde para baixo)
              coroas de ouro entre as ruínas.
            </MobileText>

            <HeaderH2>Triplos (1-4,1-4,1-4) - Taverna</HeaderH2>
            <MobileText>
              A ruína de uma taverna é reconhecível por sua placa ainda
              pendurada na parede. A parte superior do edifício está arruinada,
              mas as adegas são escavadas na rocha e ainda estão cheias de
              barris. Há canecas e copos quebrados por toda parte.
            </MobileText>
            <MobileText>
              Você poderia facilmente vender os barris por um bom preço.
              Infelizmente seus homens também estão interessados no conteúdo! O
              líder do bando deve fazer um teste de Vontade CD 14. Se passar, o
              bando ganha 1d20 coroas de ouro em vinhos e cervejas que podem ser
              vendidos imediatamente.
            </MobileText>
            <MobileText>
              Se falhar, os homens bebem a maior parte do álcool apesar das
              ameaças e xingamentos de seu líder. Você tem 1d20/5 (arredonde
              para baixo) coroas de ouro em álcool restantes quando o bando
              chega ao acampamento.
            </MobileText>
            <MobileText>
              Bandos Mortos-Vivos, Caçadores de Bruxas e Irmãs de Sigmar passam
              automaticamente neste teste, pois não são tentados por coisas
              mundanas como álcool.
            </MobileText>
            ...
            <MobileText>
              ...
              saqueada há muito tempo. Carvão e escória cobrem o chão, mas ainda
              podem haver armas a serem encontradas entre os escombros.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              ...
              <br />
              <strong>13-16:</strong> 1d20/5 Alabardas
              <br />
              <strong>17-18:</strong> Lança
              <br />
              <strong>19-29:</strong> 1d20/2 coroas de ouro em metal (adicione o
            ...
            <MobileText>
              <strong>
                Culto dos Possuídos, Saqueadores Homem-Fera, Filhos de Hashut ou
                Corsários Druchii
              </strong>{" "}
              podem sacrificar as vítimas (sem dúvida terminando o trabalho dos
              captores). Todos os Hérois do bando ganham +50 XP.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              <strong>Outros bandos</strong> podem escoltar os prisioneiros para
              fora da cidade. Por seus problemas, são recompensados com 1D20/4
              coroas de ouro. Além disso, um dos prisioneiros decide que deseja
              se juntar ao bando. Se você puder equipar o novo recruta com armas
              e armaduras, pode adicionar um novo Soldado humano ao seu bando.
              (usa estatísticas de um Recruta dos mercenários.)
            </MobileText>
            ...
            <MobileText>
              Esta cabana foi uma vez a oficina de um flecheiro - um fabricante
              de arcos e flechas. Há feixes de madeira de teixo e varas de
              salgueiro por toda parte.
            </MobileText>
            <MobileText>Role um 1d20 para ver o que você encontra:</MobileText>
            <MobileText>
              <strong>1-7:</strong> 1D20/5 Arcos Curtos
              <br />
              <strong>8-12:</strong> 1D20/5 Arcos
              <br />
              <strong>13-15:</strong> 1D20/5 Arcos Longos
              <br />
              <strong>14-16:</strong> Aljava de Flechas de Caça
              <br />
              <strong>17-20:</strong> 1D20/5 Bestas
            </MobileText>

            <HeaderH2>Triplos (17-19,17-19,17-19) - Salão de Comércio</HeaderH2>
            <MobileText>
              ...
              gravemente danificado, mas o mercado coberto ainda oferece um bom
              abrigo. Os restos do último dia de mercado ainda estão espalhados
              nos paralelepípedos. A maior parte disso é cerâmica quebrada e
              panelas de ferro.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              Você ganha os serviços de qualquer um Mercenário (escolha entre os
              disponíveis para seu bando) pela duração do próximo jogo,
              gratuitamente. Após a batalha ele partirá, ou você pode continuar
              pagando por sua manutenção normalmente.
            </MobileText>
            ...
            <MobileText>
              Você encontra a oficina de um engenheiro militar anão. Suas portas
              foram arrombadas e os quartos saqueados, mas algumas das
            ...
            <MobileText>
              ...
              Duelista
              <br />
              <strong>13-16-:</strong> 1d20/5 Arcabuzes
              <br />
              <strong>17-19:</strong> 1d20/5 Frascos de Pólvora Superior
              <br />
            ...
            <MobileText>
              Seu bando pode saquear o santuário e ganhar 1d20 coroas de ouro em
              saque.
            </MobileText>
            <MobileText>
              <strong>
            ...
            <MobileText>
              Esta casa de três andares era a sede da administração da cidade. A
              rua agora está em ruínas, mas este prédio permanece em grande
            ...
            <MobileText>Role um D20 para ver o que você encontra:</MobileText>
            <MobileText>
              <strong>1-10:</strong> 1D20/5 Escudos
              <br />
              <strong>11-13:</strong> 1D20/5 Elmos
              <br />
              <strong>14-16:</strong> 1D20/5 Armaduras Leves
              <br />
              <strong>=17-18:</strong> 1D20/5 Armaduras Pesadas
              <br />
            ...
            <MobileText>
              Você encontra um cemitério antigo, repleto de sepulcros que estão
              cobertos de erva daninha. Os monumentos aos mortos são grotescos e
              decorados com gárgulas esculpidas. Parece que algumas das criptas
              já foram arrombadas por ladrões de túmulos.
            </MobileText>
            <MobileText>
              <strong>
            ...
            <MobileText>
              Se você saquear o cemitério, na próxima vez que jogar contra Irmãs
              de Sigmar ou Caçadores de Bruxas, todo o bando inimigo terá a
              característica Ódio contra todos os modelos em seu bando.
            </MobileText>
            <MobileText>
              <strong>Caçadores de Bruxas e Irmãs de Sigmar</strong> podem selar
              os túmulos. Eles serão recompensados por sua piedade com 50 pontos
              de Experiência para cada héroi do bando.
            </MobileText>
            ...
            <MobileText>
              ...
              nível do solo. Eles são posicionados no final do primeiro turno de
              jogo e não podem ser posicionados dentro de 20cm de qualquer
              modelo inimigo.
            </MobileText>
            <MobileText>
              Isso representa suas figuras fazendo seu caminho através dos
              túneis, infiltrando-se nas linhas inimigas e emergindo subitamente
              de baixo da terra.
            </MobileText>
            ...
            <MobileText>
              Uma mansão grandiosa, construída solidamente em pedra, sobreviveu
              ao cataclisma notavelmente bem. Um brasão esculpido adorna a verga
              acima da porta, embora tenha sido danificado por saqueadores e os
              símbolos agora são irreconhecíveis. A própria porta foi arrombada
              a machadadas e está pendurada nas dobradiças.
            </MobileText>
            <MobileText>
              Dentro, escondido entre os escombros, você encontra 1d20x10 coroas
              de ouro para adicionar ao seu tesouro.
            </MobileText>
            ...
            <MobileText>
              ...
              do cometa. O chão de pedra tem símbolos estranhos entalhados e há
              gráficos e símbolos astrológicos pintados nas paredes.
            </MobileText>
            <MobileText>
              Nas ruínas você encontra saque no valor de 1d29 coroas de ouro e
              um caderno velho e batido. Um de seus Heróis pode estudar o
              caderno do Alquimista, e a sabedoria extra que ele ganha permitirá
              que ele escolha entre habilidades da lista Acadêmica sempre que
              ganhar uma nova habilidade, além daquelas normalmente disponíveis
              para ele.
            </MobileText>
            ...
            <MobileText>Role um D20 para ver o que você encontra:</MobileText>
            <MobileText>
              <strong>1-7:</strong> Pedras de quartzo no valor de 1d20 coroas de
              ouro
              <br />
              ...
              <br />
              <strong>18-20:</strong> Um rubi no valor de 1d20x15 coroas de ouro
            </MobileText>
            <MobileText>
              Se seu bando não vender as pedras preciosas, um de seus Heróis
              pode mantê-las e exibi-las orgulhosamente. Ele ganhará +3 nas
              rolagens de procurar no mercado negro e procurar mercenários, pois
              mercadores se aglomeram em torno de um guerreiro obviamente rico.
            </MobileText>
            ...
            <MobileText>
              ...
              inseguro para todos, exceto os mais ousados. Contudo seu faro para
              pedra-bruxa o atrai para esse lugar.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              Você encontra uma entrada bem escondida para as catacumbas escuras
              que se estendem por quilômetros sob a cidade de Mordheim. Embora a
              entrada pareça aterrorizante, os túneis economizarão horas em suas
              buscas pela cidade.
            </MobileText>
            <MobileText>
            ...
            <HeaderH2>Sêxtuplos (1-4,1-4,1-4,1-4,1-4,1-4) - O Abismo</HeaderH2>
            <MobileText>
              Você encontrou o Abismo, a enorme cratera criada pelo cometa. Uma
              nuvem negra ainda para sob ela, mas você pode ver Pedra-Bruxa
              brilhando por toda parte. Este é o domínio do Lorde das Sombras, o
              senhor dos Possuídos, e ninguém é bem-vindo aqui - nem mesmo seus
              próprios seguidores!
            </MobileText>
            <MobileText>
              Se desejar, você pode enviar um de seus Heróis para procurar por
              Pedra-Bruxa escondida aqui. Role um D20. Em uma rolagem de 1-5, o
              Herói é devorado pelos guardiões do Abismo e nunca mais é visto.
              Em uma rolagem de 6 ou mais, ele retorna com 6 fragmentos de
              Pedra-Bruxa.
            </MobileText>
            ...
            <HeaderH2>
              Sêxtuplos (13-16,13-16,13-16,13-16,13-16,13-16) - Bando Massacrado
            </HeaderH2>
            <MobileText>
              Você encontra os corpos de um bando inteiro. Cadáveres retorcidos
              estão espalhados entre as ruínas, dilacerados por alguma criatura
              monstruosa. Você vê uma forma enorme, que parece uma criatura
              Possuída, cambaleando para longe.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              Durante tempos melhores, Mordheim era famosa por seus duelistas e
              gladiadores. Você encontrou uma das arenas usadas para treinar
              estes guerreiros. O lugar está cheio de material de treinamento e
              armas de madeira.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              ...
              completamente saqueada e todos os móveis tiveram sua madeira nobre
              e decorações de metal precioso arrancadas. Fragmentos de cerâmica
              quebrada da mais fina qualidade estão espalhados pelo chão.
            </MobileText>
            <MobileText>
              Role um D20. Se rolar 1-7, você encontra itens e dinheiro no valor
              de 1d20x10 coroas de ouro para adicionar ao seu tesouro. Em uma
              rolagem de 8-15, você encontra 5 frascos de Sombra Carmesim. Em
              uma rolagem de 16-20 você encontra um artefato mágico escondido
              cuidadosamente oculto em uma adega escondida ou atrás de uma porta
              secreta. Role na tabela de Artefatos Mágicos.
            </MobileText>
            ...
            <MobileText>
              ...
              determinar qual item você encontra. Em uma campanha, nenhum destes
              itens pode aparecer mais de uma vez, então se você encontrar um
              item mágico que já está na posse de outra pessoa, role novamente -
              mesmo que o guerreiro que o carregava tenha sido morto.
            </MobileText>
            ...
            <MobileText>
              ...
              'Aranha' por seus roubos ousados. O segredo de seu sucesso era um
              par de botas encantadas e uma corda mágica que ele havia adquirido
              de terras distantes de Araby.
            </MobileText>
            <MobileText>
            ...
            <MobileText>
              ...
              conhecido como o 'Corsário Negro'. Alega-se que ele a encontrou em
              ruínas élficas antigas e a lenda também diz que a lâmina da adaga
              não pode ser danificada de forma alguma.
            </MobileText>
            <MobileText>
              A adaga é tratada como uma espada. Ela causa um ataque crítico em
              uma rolagem de ataque de 18+ e seu crítico causa 8 de dano extra
              ao invés de 5. Causa dano mágico.
            </MobileText>
            ...
            <MobileText>
              <strong>Runa do Devorador de Magias:</strong> O Herói usando esta
              armadura é imune a todas as magias.
              <br />
              <strong>Runa de Passagem:</strong> O Herói pode se mover através
              de peças de terrenos e outras miniaturas, contanto que não termine
              o movimento sobre elas (isso não significa que ele pode ver
              através delas).
              <br />
            ...
            <MobileText>
              Qualquer flecha disparada usando este arco mágico ignora qualquer
              tipo de terreno interposto e cobertura, visto que transforma as
              flechas disparadas em flechasa espectrais. Adicionalmente, esse
              arco sempre considera apenas a armadura base do alvo para cálculo
              do dano.
            </MobileText>
            ...
            <MobileText>
              ...
              sempre que ele reduz uma criatura com 0 de vida, ganha +1 de
            ...
            <MobileText>
              Esta joia foi recuperada das ruínas de Numas, longe ao sul. Ela dá
              a seu portador pesadelos horríveis que predizem seu futuro.
            </MobileText>
            <MobileText>
              ...
              role dois dados de exploração para o portador na fase de campanha
              ao rolar na tabela de Exploração). O portador também ganha +2 de
              Ímpeto para se defender de ataques a distância e em lutas fora da
              sua ativação, pois pode sentir os ataques antes que sejam feitos.
            </MobileText>
            <MobileText>

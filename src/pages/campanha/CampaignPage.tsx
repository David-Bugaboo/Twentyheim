        ...
        <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48">
            ...
            <div className="space-y-6">
              ...
              <MobileText className="mb-6">
                Enquanto 20Heim pode ser jogada com jogos isoladas, essa não é a
                forma ideal de jogar. A melhor forma é jogar uma campanha, uma
                cadeia de jogos interconectados, onde cada jogo tem
                consequências para o futuro do bando, e seus hérois crescem em
                poder e posses. Após um jogo, começa a Fase de Campanha, onde os
                jogadores desenrolarão as várias consequências do que foi feito
                no jogo anterior.
              </MobileText>
              ...
              <MobileText>
                Vender fragmentos de Pedra-Bruxa coletados
              </MobileText>
